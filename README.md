...
After installation, I had to post a few configurations to my Kibana instance in order to start adding agents to monitor. I did this by initializing my POP_OS! as the fleet server.
